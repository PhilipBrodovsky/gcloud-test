...
const apps = [
	{ name: "sockerManager", label: "Soccer Manger" },
	{ name: "todoList", label: "Todo" },
...
export function AppLayout(props: Props) {
	...
	const drawer = (
		<div>
			<Toolbar>
				<Typography variant="h3">EasyLife</Typography>
			</Toolbar>
			<Divider />
			<List>
				{apps.map((app, index) => (
		...
		<Box sx={{ display: "flex" }}>
			...
			>
				...
				<Typography paragraph>
					...
					Adipiscing elit duis tristique sollicitudin nibh sit. Ornare aenean euismod elementum
					nisi quis eleifend. Commodo viverra maecenas accumsan lacus vel facilisis. Nulla
